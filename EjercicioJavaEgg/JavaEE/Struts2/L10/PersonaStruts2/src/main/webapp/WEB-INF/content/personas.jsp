...
<html>
    ...
    <body>
        ...
        <s:form>
            ...
            <s:textfield key="form.nro.calle" name="persona.domicilio.numeroCalle"/>
        ...
        <s:text name="form.nro.calle"/>:<s:property value="persona.domicilio.numeroCalle"/><br/>
        ...
        <s:a href="%{localeES}"><s:text name="form.idioma.castellano"/></s:a>
            |
